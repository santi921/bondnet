...
#                 hydrolysed_products['epoxide'] = pmg_frags
        ...
        if (fg_s[1] == 'organophosphorus ester with oxygen'):
            ...
            for bp in poss_bond_pairs:
                ...
                if (
                    (at_1 == 'P' or at_1 == 'O') and
                    (at_2 == 'P' or at_2 == 'O') and
                    (b_12 == 1.0)
                ):
                    edi_mol = Chem.EditableMol(rdkit_mol)
                    edi_mol.RemoveBond(bp[0],bp[1])
        ...
        if (fg_s[1] == 'organophosphorus ester with sulphur'):
            ...
            for bp in poss_bond_pairs:
                ...
                if (
                    (at_1 == 'P' or at_1 == 'S') and
                    (at_2 == 'P' or at_2 == 'S') and
                    (b_12 == 1.0)
                ):
                    edi_mol = Chem.EditableMol(rdkit_mol)
                    edi_mol.RemoveBond(bp[0],bp[1])
            ...
            for bp in poss_bond_pairs:
                ...
                if (
                    ...
                    if (flag == 0):
                      ...
                      (at_1 == 'C' and at_2 == 'O' and b_12 == 2.0)
                ):
                    ab_1 = bp[0]

                elif (
                      (at_1 == 'O' and at_2 == 'C' and b_12 == 2.0)
                ):
                    ab_1 = bp[1]
        ...
        if (fg_s[1] == 'amide'):
            ...
            for bp in poss_bond_pairs:
                ...
                if (
                    (at_1 == 'C' or at_1 == 'N') and
                    (at_2 == 'C' or at_2 == 'N') and
                    (b_12 == 1.0)
                ):
                    edi_mol = Chem.EditableMol(rdkit_mol)
                    edi_mol.RemoveBond(bp[0],bp[1])
            ...
            for bp in poss_bond_pairs:
                ...
                if (
                    ...
                    if (flag == 0):
                      ...
                      (at_1 == 'C' or at_1 == 'S') and
                      (at_2 == 'C' or at_2 == 'S') and
                      (b_12 == 1.0)
                ):
                    if (flag == 0):
                        edi_mol = Chem.EditableMol(rdkit_mol)
        ...
        if (fg_s[1] == 'nitrile'):
            pmg_frags = []
            mod_mol = Chem.ReplaceSubstructs(rdkit_mol, Chem.MolFromSmiles('C#N'),
        ...
        if (fg_s[1] == 'Nitrogen-Sulphur'):
            ...
            for bp in poss_bond_pairs:
                ...
                if (
                    (at_1 == 'N' or at_1 == 'S') and
                    (at_2 == 'N' or at_2 == 'S') and
                    (b_12 == 1.0)
                ):
                    edi_mol = Chem.EditableMol(rdkit_mol)
                    edi_mol.RemoveBond(bp[0],bp[1])
        ...
        if (fg_s[1] == 'acid chloride'):
            ...
            for bp in poss_bond_pairs:
                ...
                if (
                    (at_1 == 'C' or at_1 == 'Cl') and
                    (at_2 == 'C' or at_2 == 'Cl') and
                    (b_12 == 1.0)
                ):
                    edi_mol = Chem.EditableMol(rdkit_mol)
                    edi_mol.RemoveBond(bp[0],bp[1])
        ...
        if (fg_s[1] == 'acid bromide'):
            ...
            for bp in poss_bond_pairs:
                ...
                if (
                    (at_1 == 'C' or at_1 == 'Br') and
                    (at_2 == 'C' or at_2 == 'Br') and
                    (b_12 == 1.0)
                ):
                    edi_mol = Chem.EditableMol(rdkit_mol)
                    edi_mol.RemoveBond(bp[0],bp[1])
        ...
        if (fg_s[1] == 'acid fluoride'):
            ...
            for bp in poss_bond_pairs:
                ...
                if (
                    (at_1 == 'C' or at_1 == 'F') and
                    (at_2 == 'C' or at_2 == 'F') and
                    (b_12 == 1.0)
                ):
                    edi_mol = Chem.EditableMol(rdkit_mol)
                    edi_mol.RemoveBond(bp[0],bp[1])
        ...
        if (fg_s[1] == 'acid iodide'):
            ...
            for bp in poss_bond_pairs:
                ...
                if (
                    (at_1 == 'C' or at_1 == 'I') and
                    (at_2 == 'C' or at_2 == 'I') and
                    (b_12 == 1.0)
                ):
                    edi_mol = Chem.EditableMol(rdkit_mol)
                    edi_mol.RemoveBond(bp[0],bp[1])
        ...
        if (fg_s[1] == 'PDK'):
            ...
            for bp in poss_bond_pairs:
                ...
                if (
                    ...
                    combo_mol = Chem.CombineMols(edi_mol_2.GetMol(),Chem.MolFromSmiles('O'))
                    if (at_1 == 'C'):
                        ab_1 = bp[0]
                    else:
                        ab_1 = bp[1]
