...
import torch
import numpy as np
from bondnet.data.dataloader import DataLoaderReactionNetwork, DataLoaderReaction
from bondnet.data.featurizer import (
    BondAsNodeGraphFeaturizerGeneral,
    AtomFeaturizerGraphGeneral,
    GlobalFeaturizerGraph,
)
from bondnet.test_utils import get_test_reaction_network_data, get_test_reaction_data
...
def test_dataloader_reaction_network():
    ...
    rxn_network = get_test_reaction_network_data(dir = "./testdata/barrier_2.json")
    ...
    data_loader = DataLoaderReactionNetwork(rxn_network, batch_size=1, shuffle=False)
    ...
    ref_label_class = [[-0.7071], [0.7071]]
    # batch size 2 case
    data_loader = DataLoaderReactionNetwork(rxn_network, batch_size=2, shuffle=False)
